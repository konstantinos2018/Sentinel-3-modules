...
model.add(keras.layers.Conv1D(filters=10, kernel_size=3, input_shape=(d_max, num_features), padding='same')) # shape of input data
#model.add(keras.layers.Conv1D(filters=10, kernel_size=3, strides=1, padding='same')) # shape of input data
...
## 1st pack of Conv/Pooling
model.add(keras.layers.Conv1D(filters=9, kernel_size=3, padding='same')) # shape of input data
#model.add(keras.layers.Conv1D(filters=9, kernel_size=3, strides=1, padding='same')) # shape of input data
#model.add(keras.layers.BatchNormalization())
model.add(keras.layers.LeakyReLU(alpha=0.8)) # activation function
...
#model.add(keras.layers.Conv1D(filters=8, kernel_size=51, padding='same')) # shape of input data
##model.add(keras.layers.Conv1D(filters=8, kernel_size=5, padding='same')) # shape of input data
##model.add(keras.layers.BatchNormalization())
#model.add(keras.layers.LeakyReLU(alpha=0.8)) # activation function
...
model.add(keras.layers.Conv1D(filters=7, kernel_size=101, padding='same')) # shape of input data
#model.add(keras.layers.Conv1D(filters=7, kernel_size=5, padding='same')) # shape of input data
model.add(keras.layers.LeakyReLU(alpha=0.8)) # activation function
model.add(keras.layers.AveragePooling1D(pool_size=3, strides=1, padding='same'))
model.add(keras.layers.Dropout(0.5))

## 4th pack of Conv/Pooling
#model.add(keras.layers.Conv1D(filters=6, kernel_size=201, padding='same'))
##model.add(keras.layers.Conv1D(filters=6, kernel_size=5, padding='same'))
#model.add(keras.layers.LeakyReLU(alpha=0.8)) # activation function
#model.add(keras.layers.AveragePooling1D(pool_size=3, strides=1, padding='same'))
#model.add(keras.layers.Dropout(0.5))

# 4th pack of Conv/Pooling
model.add(keras.layers.Conv1D(filters=5, kernel_size=901, padding='same'))
#model.add(keras.layers.Conv1D(filters=5, kernel_size=51, padding='same'))
model.add(keras.layers.LeakyReLU(alpha=0.8)) # activation function
model.add(keras.layers.AveragePooling1D(pool_size=3, strides=1, padding='same'))
model.add(keras.layers.Dropout(0.5))

## 4th pack of Conv/Pooling
#model.add(keras.layers.Conv1D(filters=5, kernel_size=101, padding='same'))
#model.add(keras.layers.LeakyReLU(alpha=0.8)) # activation function
#model.add(keras.layers.AveragePooling1D(pool_size=3, strides=1, padding='same'))
#model.add(keras.layers.Dropout(0.5))

#model.add(keras.layers.Conv1D(filters=5, kernel_size=201, padding='same'))
#model.add(keras.layers.LeakyReLU(alpha=0.8)) # activation function
#model.add(keras.layers.AveragePooling1D(pool_size=3, strides=1, padding='same'))
#
#model.add(keras.layers.Conv1D(filters=5, kernel_size=301, padding='same'))
#model.add(keras.layers.LeakyReLU(alpha=1)) # activation function
#model.add(keras.layers.AveragePooling1D(pool_size=3, strides=1, padding='same'))
#model.add(keras.layers.Dropout(0.5))

#model.add(keras.layers.Conv1D(filters=5, kernel_size=3, padding='same'))
#model.add(keras.layers.LeakyReLU(alpha=1)) # activation function
#model.add(keras.layers.AveragePooling1D(pool_size=3, strides=1, padding='same'))
#
#model.add(keras.layers.Conv1D(filters=5, kernel_size=3, padding='same'))
...
#model.add(keras.layers.LeakyReLU(alpha=0.8))
#
#model.add(keras.layers.Dense(units=50, use_bias=True))
#model.add(keras.layers.LeakyReLU(alpha=0.8))
